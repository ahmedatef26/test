...
//             headerImage.setAttribute("style", "background: url("+ ASSET_URL + "/imgs/mob_banner_dark.webp) no-repeat;");
//         }else{
//             headerImage.setAttribute("style", "background: url("+ ASSET_URL + "/imgs/lecture_banner_dark.webp) no-repeat;");
//         }
//     } else {
//         if(window.innerWidth <= 765){
//             headerImage.setAttribute("style", "background: url("+ ASSET_URL + "/imgs/mob_banner.webp) no-repeat;");
//         }else{
//             headerImage.setAttribute("style", "background: url("+ ASSET_URL + "/imgs/lecture_banner.webp) no-repeat;");
//         }
//     }
// };
let funChangeImagesDark = function () {
    ...
    if (document.documentElement.classList.contains("dark")) {
        headerImage.setAttribute(
            "style",
            "background: url(" + ASSET_URL + "/imgs/lecture_banner_dark.webp) no-repeat; background-size:cover;"
        );
    } else {
        headerImage.setAttribute(
            "style",
            "background: url(" + ASSET_URL + "/imgs/lecture_banner.webp) no-repeat; background-size:cover;"
        );
    }
};
