...
let funChangeImagesDark = function () {
    ...
    if (!document.documentElement.classList.contains("dark")) {
        paperImg1.setAttribute(
            "style",
            "background: url(" +
            ASSET_URL + "/imgs/paper.webp) no-repeat; background-size:cover;"
        );
        paperImg2.setAttribute(
            "style",
            "background: url(" +
            ASSET_URL + "/imgs/paper2.webp) no-repeat; background-size:cover;"
        );
    } else {
        paperImg1.setAttribute(
            "style",
            "background: url(" +
            ASSET_URL + "/imgs/paperdark.webp) no-repeat; background-size:cover;"
        );
        paperImg2.setAttribute(
            "style",
            "background: url(" +
            ASSET_URL + "/imgs/paper2_dark.webp) no-repeat; background-size:cover;"
        );
    }
};
